...
/*
*function：void PASSCRC(unsigned char *data,unsigned int dataLen)
*decription:  将CRC校验码放到数据中
*input:
*output:
*/
...
{
    unsigned int CRCx;
    CRCx=CRC16(data,dataLen);
    data[dataLen]=CRCx>>8;   //CRC高位
    data[dataLen+1]=CRCx;    //CRC低位
}
